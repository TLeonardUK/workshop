...
// ================================================================================================
class dx12_render_command_queue : public render_command_queue
{
public:
    dx12_render_command_queue(dx12_render_interface& renderer, const char* debug_name, D3D12_COMMAND_LIST_TYPE queue_type);
    virtual ~dx12_render_command_queue();

    // Creates the dx12 resources required by this swapchain.
    result<void> create_resources();

    virtual render_command_list& alloc_command_list() override;
    virtual void execute(render_command_list& list) override;
...
private:
    ...
    std::vector<std::unique_ptr<dx12_render_command_list>> m_command_lists;
