...
dx12_render_descriptor_heap::dx12_render_descriptor_heap(dx12_render_interface& renderer, D3D12_DESCRIPTOR_HEAP_TYPE heap_type, size_t count)
    : m_renderer(renderer)
...
dx12_render_descriptor_heap::~dx12_render_descriptor_heap()
{
    m_heap = nullptr;
}

result<void> dx12_render_descriptor_heap::create_resources()
{
...
D3D12_CPU_DESCRIPTOR_HANDLE dx12_render_descriptor_heap::allocate()
{
    db_assert(!m_free_list.empty());
...
void dx12_render_descriptor_heap::free(D3D12_CPU_DESCRIPTOR_HANDLE handle)
{
