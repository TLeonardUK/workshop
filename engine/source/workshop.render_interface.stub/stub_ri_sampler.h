...
// ================================================================================================
//  Stub implementation of a texture sampler, performs no actual work.
// ================================================================================================
class stub_ri_sampler : public ri_sampler
{
public:
    stub_ri_sampler(const create_params& params, const char* debug_name);
