...
// ================================================================================================
//  Stub implementation of a renderer, performs no actual work. Useful for headless builds or
//  platforms that do not have a real rendering implementation available.
// ================================================================================================
class stub_render_interface : public ri_interface
{
public:
    stub_render_interface(size_t ray_type_count, size_t ray_domain_count);
    virtual ~stub_render_interface();
...
private:
    ...
    stub_ri_command_queue m_graphics_queue;
    stub_ri_command_queue m_copy_queue;
