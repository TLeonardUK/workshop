...
// ================================================================================================
//  Stub implementation of a gpu buffer, performs no actual work.
// ================================================================================================
class stub_ri_buffer : public ri_buffer
{
public:
    stub_ri_buffer(const create_params& params, const char* debug_name);
