...
void render_system_selection_outline::build_graph(render_graph& graph, const render_world_state& state, render_view& view)
{
    ...
    {
        outline_param_block->set("uv_step"_sh, vector2(
    ...
    if (view.has_render_target())
    {
        outline_param_block->set("gbuffer_scale"_sh, vector2(
    ...
    outline_param_block->set("outline_color"_sh, color::gold.rgba());
    outline_param_block->set("fill_alpha"_sh, 0.25f);
