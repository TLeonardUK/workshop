...
std::unique_ptr<ri_pipeline> shader::make_technique_pipeline(const technique& instance)
{
    ...
    params.bindless_arrays_types.push_back(ri_data_type::t_texture1d);
    params.bindless_arrays_types.push_back(ri_data_type::t_texture2d);
    params.bindless_arrays_types.push_back(ri_data_type::t_texture3d);
    params.bindless_arrays_types.push_back(ri_data_type::t_texturecube);
    params.bindless_arrays_types.push_back(ri_data_type::t_sampler);
    params.bindless_arrays_types.push_back(ri_data_type::t_byteaddressbuffer);

    for (param_block& block : param_blocks)
    {
