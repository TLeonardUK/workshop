...
private:
    ...
    bool preprocess_source(const char* path, std::string& source, std::string& stub);
    bool preprocess_replaced_function(const char* path, const char*& read_ptr, std::string& result, std::string& stub, int function_index);
