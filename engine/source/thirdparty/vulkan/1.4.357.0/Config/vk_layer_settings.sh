...
#!  changes.
export VK_LUNARG_GFXRECONSTRUCT_CAPTURE_TRIGGER_BOUNDARY=frames
...
#! This setting has sub-settings:
#! - export VK_KHRONOS_VALIDATION_LEGACY_DETECTION_MODE=ALWAYS
...
#! This setting requires ALL of the following values:
#! - export VK_KHRONOS_VALIDATION_LEGACY_DETECTION=true
#! export VK_KHRONOS_VALIDATION_LEGACY_DETECTION_MODE=ALWAYS (Commented out as the set of dependences is not satisfied)
...
#!  When turned on, shaders are NOT instrumented unless selected. This can be
#!  done by:
...
- Providing a
#!  CDL dump file to parse the debug names from it.
...
#!  Path to a Crash Diagnostic Layer (CDL) dump file. Pipeline names found in
#!  this file will be selected for instrumentation.
#! This setting requires ALL of the following values:
#! - export VK_KHRONOS_VALIDATION_GPUAV_ENABLE=true
#! - export VK_KHRONOS_VALIDATION_GPUAV_SELECT_INSTRUMENTED_SHADERS=true
#! export VK_KHRONOS_VALIDATION_GPUAV_CDL_DUMP_PATH= (Commented out as the set of dependences is not satisfied)
...
#!  Disable DontInline SPIR-V function hint for instrumentations functions, at
#!  the cost of a performance boost if the driver supports it. This flag can
#!  provoke instabilities on some drivers. Currently a debug option until we
#!  learn more about these instabilities.
#! This setting requires ALL of the following values:
#! - export VK_KHRONOS_VALIDATION_GPUAV_ENABLE=true
#! export VK_KHRONOS_VALIDATION_GPUAV_DEBUG_DISABLE_DONTINLINE=false (Commented out as the set of dependences is not satisfied)
...
#! This setting has sub-settings:
#! - export VK_KHRONOS_VALIDATION_DESCRIPTOR_HASHING_TOTAL_DESCRIPTORS=65536
...
#! This setting requires ALL of the following values:
#! - export VK_KHRONOS_VALIDATION_DESCRIPTOR_HASHING=true
#! export VK_KHRONOS_VALIDATION_DESCRIPTOR_HASHING_TOTAL_DESCRIPTORS=65536 (Commented out as the set of dependences is not satisfied)
...
#!  comma separated and can be either the entire VUID string, the hashed value,
#!  or the last 5 digit number of a VUID
#! This setting can list multiple values using the "," (comma) separator.
